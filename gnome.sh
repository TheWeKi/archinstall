...
pacman --noconfirm -S gdm gnome firewalld modemmanager usb_modeswitch power-profiles-daemon switcheroo-control gnome-power-manager thermald plocate gnome-tweaks libreoffice-still
